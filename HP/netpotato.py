import time, random, pygame, os, networking
import math as m
...
while not crashed:
    ...
    for i in player_list:
        result = networking.send_input([0,0,0,0,i.playerinfo.cstate[0],i.playerinfo.cstate[2],i.playerinfo.cstate[1],i.playerinfo.cstate[3]])
        print(result)
        i.playerinfo.coordinates = result[1]
